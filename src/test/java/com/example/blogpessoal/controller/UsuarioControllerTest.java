...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L,
				"Paulo Antunes", "paulo@hotmail.com.br", "https://i.imgur.com/FETvs20.jpg",  "12345678"));
    ...
    public void naoDeveDuplicarUsuario() {
        ...
        usuarioService.cadastrarUsuario(new Usuario(0L, 
        	"Manuela da Silva",  "manu@hotmail.com.br", "https://i.imgur.com/NtyGneo.jpg", "12345678"));
        HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, 
        	"Manuela da Silva",  "manu@hotmail.com.br", "https://i.imgur.com/NtyGneo.jpg", "12345678"));
    ...
    public void deveAtualizarUmUsuario() {
        ...
        Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), 
            "Juliana Andrews Ramos",  "juliana_ramos@email.com.br", "https://i.imgur.com/T12NIp9.jpg","juliana123");
    ...
    public void deveMostrarTodosUsuarios() {
        ...
        usuarioService.cadastrarUsuario(new Usuario(0L, 
            "Sabrina Sanches", "sabrina_sanches@email.com.br", "https://i.imgur.com/EcJG8kB.jpg", "sabrina123"));
